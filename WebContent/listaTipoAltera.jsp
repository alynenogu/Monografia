...
<img src="<%=request.getContextPath()%>/html/imagens/logotiponovo.png" />
	<table>
		...
		<tr>
				...
				<td><a href="AlteraTipo.jsp?idTipo=<%=tipo.getIdTipo()%> &nometipo=<%=tipo.getNometipo()%> &descricaotipo=<%=tipo.getDescricaotipo()%>"><%=tipo.getIdTipo() %></a></td>
			
				<td><%=tipo.getNometipo() %></td>
