...
<table>
	<%
		...
		%>
			...
			<td> <a href ="removeHospital.jsp?idEstabelecimento=<%=tipo_de_estabelecimento.getIdEstabelecimento()%> &nomeEstabelecimento=<%=tipo_de_estabelecimento.getNomeEstabelecimento()%>"> <%=tipo_de_estabelecimento.getNomeEstabelecimento()%> </a></td>
