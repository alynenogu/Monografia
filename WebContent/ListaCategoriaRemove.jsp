...
<title>Lista Categoria Remove</title>
...
<img src="<%=request.getContextPath()%>/html/imagens/logotiponovo.png" />
		...
		<tr>
				...
				<td><a href="removeCategoria.jsp?idcategoria=<%=categoria.getIdcategoria()%>&nomecategoria=<%=categoria.getNomecategoria()%>"><%=categoria.getNomecategoria() %></a> </td>
